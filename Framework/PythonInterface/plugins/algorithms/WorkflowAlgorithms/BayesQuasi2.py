...
from IndirectImport2 import *
from mantid.api import (PythonAlgorithm, AlgorithmFactory, MatrixWorkspaceProperty, PropertyMode,
                        WorkspaceGroupProperty, Progress)
from mantid.kernel import StringListValidator, Direction
import mantid.simpleapi as s_api
from mantid import config, logger
from IndirectCommon2 import *
from python.qldata_main import QLdata
...
class AntBayes(PythonAlgorithm):
    _program = None
    _samWS = None
    _resWS = None
    _resnormWS = None
    ...
    def PyExec(self):
        ...
        for spectrum in range(0, nsam):
            ...
            names = {"numb":numb, "Xv":Xv, "Yv":Yv, "Ev":Ev,"reals": reals,"fitOp": fitOp,
                                                              "Xdat":Xdat, "Xb":Xb, "Yb":Yb,"Wy": Wy,
                                                              "We":We, "dtn":dtn,"xsc": xsc,
                                                              "wrks":wrks, "wrkr":wrkr, "lwrk":lwrk}
            ...
            #for j in names.keys():
            #        data =""
            #        if isinstance(names[j],float) or isinstance(names[j],int) or isinstance(names[j],str):
            #            data = str(names[j])
            #        else:
            #           for n in names[j]:
            #            data+=str(n)+"\n"
            ...
            if prog == 'QLr':
                ...
                nd, xout, yout, eout, yfit, yprob = QLr.QLr(numb, Xv, Yv, Ev, reals, fitOp,
                ...
                nd, xout, yout, eout, yfit, yprob = QLdata(numb, Xv, Yv, Ev, reals, fitOp,
                                                               Xdat, Xb, Yb, Eb, Wy, We,
                                                               wrks, wrkr, lwrk, overwrite)
                overwrite= False
    ...
    def C2Fw(self, sname):
        ...
        for nl in range(1, 4):
            ...
            file_name = sname + '.python.ql' + str(nl)
...
AlgorithmFactory.subscribe(AntBayes)
